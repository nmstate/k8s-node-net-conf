...
func formatErrorString(err error) string {
	...
	encodedMessage, err := flateString(errorMessage)
...
func flateString(src string) (string, error) {
...
func decodeFlateString(flateString string) string {
	data, _ := b64.StdEncoding.DecodeString(flateString)
